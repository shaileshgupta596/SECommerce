...
urlpatterns = [
    ...
    path("user_followers/<int:user_id>/", views.user_follower_view, name="other-user-followers"),
    path("user_following/<int:user_id>/", views.user_following_view, name="other-user-following"),
